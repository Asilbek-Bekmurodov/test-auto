export const images = {
  ...
  boshSahifa: new URL("./House.svg", import.meta.url).href,
  ...
  tayyorlov: new URL("./tayyorlov.svg", import.meta.url).href,
  real: new URL("./real.svg", import.meta.url).href,
  belgilar: new URL("./belgilar.svg", import.meta.url).href,
  ...
  darkHome: new URL("./lighthouse.png", import.meta.url).href,
  darkTalim: new URL("./darkTalim.svg", import.meta.url).href,
  darkYangilik: new URL("./yangiliklarDark.svg", import.meta.url).href,
  darkXatolar: new URL("./xatolarDark.svg", import.meta.url).href,
